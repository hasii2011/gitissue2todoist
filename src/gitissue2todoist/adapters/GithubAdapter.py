...
# as a standalone applications.  The noinspection comments I include because
    ...
    def getIssuesAssignedToOwner(self, slugs: Slugs, issueOwner: IssueOwner, callback: IssuesCallback) -> AbbreviatedGitIssues:
        ...
        for slug in slugs:
            ...
            for issue in openIssues:
                potentialIssue: Issue = issue
                assignee: NamedUser | None = potentialIssue.assignee
                # TODO:  Might want to look through the assignees list also
                if assignee is None:
                    pass
                elif assignee.login == issueOwner:

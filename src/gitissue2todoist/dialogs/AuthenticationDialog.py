...
class AuthenticationDialog(Window):
    ...
    def __init__(self, preferences: Preferences):
        ...
        saveButton:   Button = Button('Save',   on_press=self._on_save,   style=Pack(padding=5))
        cancelButton: Button = Button('Cancel', on_press=self._on_cancel, style=Pack(padding=5))

...
ProjectDataTypes = Union[Items, Project, ProjectNotes, Sections]
...
class TodoistCreateByRepository(AbstractTodoistStrategy):
    ...
    def _getMilestoneTaskItem(self, projectId: str, milestoneName: str, progressCb: TodoistProgressCB) -> Task:
        ...
        milestoneTask:  Task  = cast(Task, None)        # noqa
    ...
    def _getProjectTaskItems(self, projectId: str) -> ProjectTasks:
        ...
        tasks:        Tasks    = self._todoistIteratorToTasks(taskIterator=taskIterator)
